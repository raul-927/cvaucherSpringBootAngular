...
<div class="well well-lg">
	<sf:form 
		...
		<div class="form-group">
			<sf:label path="tratamId" for ="tratamId">Tratamiento</sf:label>
				<sf:select cssClass ="form-control" path="tratamId" size ="1" >
					<sf:options path="tratamId" items="${tratP}" itemLabel="descripcion"  itemValue="tratamId"/>
				</sf:select>
		...
		<div class="botonForm">
			...
			<input class="btn btn-primary" type ="submit" value ="Ingresar Tratamiento" name ="_eventId_cantSesionesTratamiento"/>	
		</div>	
	</sf:form>
</div>
