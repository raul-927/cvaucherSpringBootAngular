...
-- Volcando datos para la tabla est_vaucher.agenda: ~70 rows (aproximadamente)
/*!40000 ALTER TABLE `agenda` DISABLE KEYS */;
INSERT IGNORE INTO `agenda` (`ag_pac_Id`, `ag_tipo`, `ag_dato`, `pac_cedula`) VALUES
...
INSERT IGNORE INTO `aux_precios` (`aux_prec_id`, `aux_prec_id_list`, `aux_prec_fech_ini`, `aux_prec_fech_fin`, `aux_prec_descripcion`) VALUES
...
-- Volcando datos para la tabla est_vaucher.direccion: ~39 rows (aproximadamente)
/*!40000 ALTER TABLE `direccion` DISABLE KEYS */;
INSERT IGNORE INTO `direccion` (`dir_id`, `tpo_Vivienda`, `calle`, `nro_Puerta`, `nro_Ap`, `calle_1`, `calle_2`, `pac_cedula`) VALUES
...
INSERT IGNORE INTO `formas_de_pagos` (`form_pag_id`, `form_pag_abreviacion`, `form_pag_desc`, `form_pag_tipo`) VALUES
	(19, 'EF', 'Efectivo', 'EF'),
...
INSERT IGNORE INTO `groups_members` (`group_id`, `username`) VALUES
	(1, 'raul');
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~237 rows (aproximadamente)
/*!40000 ALTER TABLE `historial_pagos` DISABLE KEYS */;
INSERT IGNORE INTO `historial_pagos` (`hist_pagos_id`, `hist_pagos_trat_pac_id`, `hist_tipo_pago`, `hist_pagos_fecha_pago`, `hist_pagos_monto`) VALUES
...
-- Volcando datos para la tabla est_vaucher.historia_clinica: ~33 rows (aproximadamente)
/*!40000 ALTER TABLE `historia_clinica` DISABLE KEYS */;
INSERT IGNORE INTO `historia_clinica` (`hist_id`, `pac_cedula`, `diabetes`, `epilepsia`, `marcaPaso`, `diu`, `problemas_cardiacos`, `medicacion`, `cant_hijos`, `operaciones`, `hipertension`, `procesos_oncologicos`, `tiroides`, `actividad_fisica`, `agua_diaria`, `alimentacion`) VALUES
...
-- Volcando datos para la tabla est_vaucher.lista_precios: ~41 rows (aproximadamente)
/*!40000 ALTER TABLE `lista_precios` DISABLE KEYS */;
INSERT IGNORE INTO `lista_precios` (`list_prec_id`, `list_prec_id_trat`, `list_prec_monto`) VALUES
	(1, 2, 650),
	(1, 7, 5500),
	(1, 8, 3200),
	(1, 9, 8900),
...
-- Volcando datos para la tabla est_vaucher.pacientes: ~36 rows (aproximadamente)
/*!40000 ALTER TABLE `pacientes` DISABLE KEYS */;
INSERT IGNORE INTO `pacientes` (`pac_id`, `pac_nombre`, `pac_apellido`, `cedula`, `pac_ocupacion`, `pac_soc_med`, `pac_em_movil`) VALUES
...
-- Volcando datos para la tabla est_vaucher.pago_efectivo: ~68 rows (aproximadamente)
/*!40000 ALTER TABLE `pago_efectivo` DISABLE KEYS */;
INSERT IGNORE INTO `pago_efectivo` (`ef_id`, `pago_ef_id`, `pago_ef_cedula`, `pago_ef_importe`, `pago_ef_desc`) VALUES
...
-- Volcando datos para la tabla est_vaucher.pago_tarjetas: ~50 rows (aproximadamente)
/*!40000 ALTER TABLE `pago_tarjetas` DISABLE KEYS */;
INSERT IGNORE INTO `pago_tarjetas` (`tarj_id`, `tarj_pac_cedula`, `tarj_pago_id`, `tarj_nro`, `tarj_desc`, `tarj_vence`, `tarj_importe`, `tarj_cuotas`) VALUES
...
INSERT IGNORE INTO `seguimiento_pacientes` (`seg_pac_id`, `trat_pac_id`, `fecha_control`, `brazo_izquierdo`, `brazo_derecho`, `muzlo_izquierdo`, `muzlo_derecho`, `abdomen`, `cintura`, `cadera`, `peso`, `imc`, `observaciones`) VALUES
...
INSERT IGNORE INTO `tipo_tratamiento` (`tip_trat_id`, `tip_trat_descripcion`) VALUES
	(1, 'Relax'),
	(2, 'Terapeutico'),
	(3, 'Modelador'),
	(4, 'Estetico'),
...
-- Volcando datos para la tabla est_vaucher.tratamiento: ~28 rows (aproximadamente)
/*!40000 ALTER TABLE `tratamiento` DISABLE KEYS */;
INSERT IGNORE INTO `tratamiento` (`trat_id`, `trat_tpo_id`, `trat_descripcion`, `trat_cant_sesiones`) VALUES
...
-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~191 rows (aproximadamente)
/*!40000 ALTER TABLE `tratamiento_paciente` DISABLE KEYS */;
INSERT IGNORE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
