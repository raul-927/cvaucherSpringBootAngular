...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~145 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.lista_precios: ~14 rows (aproximadamente)
...
-- Volcando estructura para tabla est_vaucher.tarjetas
...
CREATE TABLE IF NOT EXISTS `tarjetas` (
  ...
  `tarj_vence` int(11) NOT NULL,
  PRIMARY KEY (`tarj_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla est_vaucher.tarjetas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.tratamiento: ~13 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~88 rows (aproximadamente)
...
REPLACE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	...
	(100, 24578956, 2, '2014-12-12', 850, 50, 800, 1),
	...
	(125, 19455549, 2, '2015-12-29', 650, 0, 0, 1),
	(126, 12542339, 2, '2015-12-29', 650, 300, 350, 1),
	(127, 44188684, 2, '2015-12-31', 650, 0, 650, 1),
