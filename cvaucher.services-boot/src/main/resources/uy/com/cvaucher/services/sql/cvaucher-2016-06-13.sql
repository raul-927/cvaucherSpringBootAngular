...
REPLACE INTO `asiento_contable` (`as_con_id`, `as_con_nro`, `as_cuenta_debe`, `as_cuenta_debeMonto`, `as_cuenta_haber`, `as_cuenta_haberMonto`, `as_con_descripcion`, `as_con_fecha`, `as_con_hora`, `as_con_usr`) VALUES
	...
	(8, 2, 30, 850, 30, 0, 'Otro 2', NULL, NULL, NULL),
	(9, 1, 2, 0, 2, 150, 'Masaje', NULL, NULL, NULL),
	(10, 1, 1, 150, 1, 0, 'Otro', '2016-06-04', NULL, NULL);
...
-- Volcando datos para la tabla est_vaucher.caja: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.cuentas: ~17 rows (aproximadamente)
...
REPLACE INTO `cuentas` (`cuenta_id`, `cuenta_form_pago_id`, `cuenta_grupo_id`, `cuenta_desc`, `cuenta_fecha`, `cuenta_hora`, `cuenta_usuario`) VALUES
	...
	(15, 0, 11, 'IRPF', '2016-06-10', '01:28:00', 'admin'),
	(16, 0, 11, 'FONASA', '2016-06-10', '01:28:01', 'admin'),
	(17, 0, 11, 'BPS', '2016-06-10', '01:29:00', 'admin');
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~2 rows (aproximadamente)
...
REPLACE INTO `impuesto` (`impuesto_id`, `impuesto_desc`, `impuesto_desc_abrv`, `impuesto_valor`, `impuesto_tipo`) VALUES
	(1, 'Impuesto al Valor Agregado', 'IVA', 22.000, 'ECONOMICO'),
	(2, 'Sin Impuestos', 'S/IMP', 0.000, 'ECONOMICO'),
	(3, 'Impuesto Recaudacion Personas Fisicas Franja 1', 'IRPF_F1', 0.000, 'PERSONAS'),
	(4, 'Impuesto Recaudacion Personas Fisicas Franja 2', 'IRPF_F2', 10.000, 'PERSONAS'),
	(5, 'Impuesto Recaudacion Personas Fisicas Franja 3', 'IRPF_F3', 18.000, 'PERSONAS'),
	(6, 'Impuesto Recaudacion Personas Fisicas Franja 4', 'IRPF_F4', 23.000, 'PERSONAS'),
	(7, 'Impuesto Recaudacion Personas Fisicas Franja 5', 'IRPF_F5', 26.000, 'PERSONAS'),
	(8, 'Impuesto Recaudacion Personas Fisicas Franja 6', 'IRPF_F6', 29.000, 'PERSONAS'),
	(9, 'Impuesto Recaudacion Personas Fisicas Franja 7', 'IRPF_F7', 34.000, 'PERSONAS'),
	(10, 'Fondo de Reconversión Laboral', 'FRL', 0.125, 'PERSONAS'),
	(12, 'Banco de Prevision Social Aporte Jubilatorio', 'BPS_AJ', 7.500, 'PERSONAS'),
	(13, 'Fondo Nacional de Salud', 'FONASA', 3.000, 'PERSONAS');
...
-- Volcando datos para la tabla est_vaucher.tratamiento: ~54 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=532 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~2 rows (aproximadamente)
