...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~189 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.pago_tarjetas: ~38 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.tratamiento: ~14 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=246 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~161 rows (aproximadamente)
...
REPLACE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	...
	(235, 19455549, 16, '2015-01-16', 380, 100, 280, 1),
