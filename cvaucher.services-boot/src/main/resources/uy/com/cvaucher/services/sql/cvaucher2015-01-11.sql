...
-- Volcando datos para la tabla est_vaucher.agenda: ~76 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.aux_precios: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.direccion: ~45 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.groups_members: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~184 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.historia_clinica: ~39 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.lista_precios: ~30 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.pacientes: ~41 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.pago_tarjetas: ~34 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.seguimiento_pacientes: ~21 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.tratamiento: ~16 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=198 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~156 rows (aproximadamente)
...
REPLACE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	...
	(96, 12034566, 2, '2014-12-12', 850, 0, 850, 1),
	...
	(106, 24577742, 2, '2014-12-12', 850, 0, 0, 1),
	...
	(126, 12542339, 2, '2015-12-29', 650, 300, 350, 1),
	...
	(171, 24577742, 12, '2015-01-09', 450, 0, 450, 1),
