...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~83 rows (aproximadamente)
...
REPLACE INTO `historial_pagos` (`hist_pagos_id`, `hist_pagos_trat_pac_id`, `hist_pagos_fecha_pago`, `hist_pagos_monto`) VALUES
	...
	(115, 77, '2014-12-05', 6300),
	(116, 77, '2014-12-05', 500),
	(117, 77, '2014-12-05', 500);
...
-- Volcando datos para la tabla est_vaucher.lista_precios: ~12 rows (aproximadamente)
...
REPLACE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	...
	(77, 44188684, 22, '2014-12-05', 8800, 7300, 1500, 20),
	(78, 44188684, 23, '2014-12-05', 6500, 0, 6500, 15);
