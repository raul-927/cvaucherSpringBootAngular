...
-- Volcando datos para la tabla est_vaucher.asiento_contable: ~21 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.caja: ~49 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `historial_pagos` DISABLE KEYS */;
REPLACE INTO `historial_pagos` (`hist_pagos_id`, `hist_pagos_caja_id`, `hist_pagos_trat_pac_id`, `hist_tipo_pago`, `hist_pagos_fecha_pago`, `hist_pagos_hora_pago`, `hist_pagos_monto`, `hist_pagos_usuario`) VALUES
...
-- Volcando datos para la tabla est_vaucher.pago_efectivo: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `pago_efectivo` DISABLE KEYS */;
REPLACE INTO `pago_efectivo` (`ef_id`, `pago_ef_caja_id`, `pago_ef_asiento_nro`, `pago_ef_id`, `pago_ef_cedula`, `pago_ef_importe`, `pago_ef_cuenta`, `pago_ef_desc`, `pago_ef_usuario`) VALUES
...
REPLACE INTO `pago_tarjetas` (`tarj_id`, `tarjeta_caja_id`, `tarjeta_asiento_nro`, `tarj_pac_cedula`, `tarj_pago_id`, `tarj_nro`, `tarj_desc`, `tarj_vence`, `tarj_importe`, `tarj_cuenta`, `tarj_cuotas`, `tarj_pago_usuario`) VALUES
...
-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~7 rows (aproximadamente)
