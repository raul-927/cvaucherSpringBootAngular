...
INSERT INTO `agenda` (`ag_pac_Id`, `ag_tipo`, `ag_dato`, `pac_cedula`) VALUES
...
CREATE TABLE IF NOT EXISTS `asiento_contable` (
  ...
  `as_cuenta_tipo` varchar(50) DEFAULT '0',
...
INSERT INTO `asiento_contable` (`as_con_id`, `as_con_caja_id`, `as_con_nro`, `as_cuenta_debe`, `as_cuenta_debeMonto`, `as_cuenta_haber`, `as_cuenta_haberMonto`, `as_cuenta_tipo`, `as_con_descripcion`, `as_con_fecha`, `as_con_hora`, `as_con_usr`) VALUES
	(295, 119, 1, 1, 4000, 1, 0, 'VENTA', 'EFECTIVO_CAJA', NULL, NULL, NULL),
	(296, 119, 1, 9, 0, 9, 880, 'IMPOSITIVO', 'IVA 22%', NULL, NULL, NULL),
	(297, 119, 1, 12, 0, 12, 3120, 'TRATAMIENTO', '15 Sesiones de 15 minutos Ultrasonido', NULL, NULL, NULL),
	(298, 119, 2, 1, 850, 1, 0, 'VENTA', 'EFECTIVO_CAJA', NULL, NULL, NULL),
	(299, 119, 2, 9, 0, 9, 187, 'IMPOSITIVO', 'IVA 22%', NULL, NULL, NULL),
	(300, 119, 2, 12, 0, 12, 663, 'TRATAMIENTO', 'Ultracavitacion', NULL, NULL, NULL),
	(301, 119, 3, 2, 10500, 2, 0, 'VENTA', 'OCA', NULL, NULL, NULL),
	(302, 119, 3, 9, 0, 9, 2310, 'IMPOSITIVO', 'IVA 22%', NULL, NULL, NULL),
	(303, 119, 3, 12, 0, 12, 8190, 'TRATAMIENTO', '10 Sesiones de 1/2 Hora de presoterapia, y 1/2 Hora de Ultracavitacion', NULL, NULL, NULL);
...
INSERT INTO `authorities` (`auth_id`, `username`, `authority`) VALUES
	(1, 'admin', 'ROLE_ADMIN'),
	(2, 'raul', 'ROLE_USER');
...
DELETE FROM `aux_precios`;
/*!40000 ALTER TABLE `aux_precios` DISABLE KEYS */;
INSERT INTO `aux_precios` (`aux_prec_id`, `aux_prec_id_list`, `aux_prec_fech_ini`, `aux_prec_fech_fin`, `aux_prec_descripcion`) VALUES
	...
	(61, 5, '2018-09-02', '2018-10-01', 'Septiembre-Octubre');
...
INSERT INTO `caja` (`caja_id`, `caja_estado`, `caja_fecha`, `caja_hora`, `caja_usr`) VALUES
	...
	(110, 'CERRADO', '2016-07-10', '19:38:01', 'admin'),
	(111, 'ABIERTO', '2016-07-10', '19:39:00', 'admin'),
	(112, 'CERRADO', '2016-07-11', '00:12:00', 'admin'),
	(113, 'ABIERTO', '2016-07-11', '00:12:00', 'admin'),
	(114, 'CERRADO', '2016-07-11', '00:16:00', 'admin'),
	(115, 'ABIERTO', '2016-07-11', '00:16:00', 'admin'),
	(116, 'CERRADO', '2016-07-11', '00:23:00', 'admin'),
	(117, 'ABIERTO', '2016-07-11', '00:24:00', 'admin'),
	(118, 'CERRADO', '2016-07-11', '00:43:00', 'admin'),
	(119, 'ABIERTO', '2016-07-11', '00:43:00', 'admin');
...
INSERT INTO `cuentas` (`cuenta_id`, `cuenta_grupo_id`, `cuenta_desc`, `cuenta_tipo`, `cuenta_fecha`, `cuenta_hora`, `cuenta_usuario`) VALUES
	(1, 8, 'EFECTIVO_CAJA', 'VENTA', '2016-05-16', '23:19:00', 'admin'),
	(2, 9, 'OCA', 'VENTA', '2016-05-16', '23:19:01', 'admin'),
	(3, 9, 'VISA', 'VENTA', '2016-05-16', '23:20:00', 'admin'),
	(4, 9, 'MASTER', 'VENTA', '2016-05-16', '23:20:00', 'admin'),
	(5, 9, 'DINERS', 'VENTA', '2016-05-16', '23:20:00', 'admin'),
	(6, 9, 'AMERICAN_EXPRESS', 'VENTA', '2016-05-22', '11:59:00', 'gaby'),
	(7, 7, 'BCP', 'VENTA', '2016-05-16', '23:20:00', 'admin'),
	(8, 7, 'BROU', 'VENTA', '2016-05-16', '23:21:00', 'admin'),
	(9, 11, 'IVA 22%', 'IMPOSITIVO', '2016-05-16', '23:45:00', 'admin'),
	(10, 11, 'IGV', 'IMPOSITIVO', '2016-05-16', '23:46:00', 'admin'),
	(11, 12, 'OCA 10%', 'IMPOSITIVO', '2016-05-16', '23:46:00', 'admin'),
	(12, 15, 'MASAJES', 'TRATAMIENTO', '2016-05-23', '21:19:00', 'admin'),
	(13, 15, 'LIMPIEZA', 'TRATAMIENTO', '2016-05-23', '21:19:00', 'admin'),
	(14, 9, 'ANDA', 'VENTA', '2016-05-31', '10:50:00', 'admin'),
	(15, 11, 'IRPF', 'IMPOSITIVO', '2016-06-10', '01:28:00', 'admin'),
	(16, 11, 'FONASA', 'IMPOSITIVO', '2016-06-10', '01:28:01', 'admin'),
	(17, 11, 'BPS', 'IMPOSITIVO', '2016-06-10', '01:29:00', 'admin'),
	(18, 11, 'FON_NAC_RES', 'IMPOSITIVO', '2016-06-29', '21:25:00', 'admin'),
	(19, 16, 'RETIRO_CAJA', 'RETIRO', '2016-07-17', '02:48:00', 'admin');
...
INSERT INTO `direccion` (`dir_id`, `tpo_Vivienda`, `calle`, `nro_Puerta`, `nro_Ap`, `calle_1`, `calle_2`, `pac_cedula`) VALUES
...
INSERT INTO `domain_user` (`dom_usr_id`, `dom_usr_nom`, `dom_usr_ap`, `dom_usr_nic`, `dom_usr_pass`, `dom_usr_enabled`) VALUES
...
INSERT INTO `formas_de_pagos` (`form_pag_id`, `form_pag_abreviacion`, `form_pag_cuenta`, `form_pag_desc`, `form_pag_tipo`) VALUES
...
DELETE FROM `groups_authorities`;
/*!40000 ALTER TABLE `groups_authorities` DISABLE KEYS */;
INSERT INTO `groups_authorities` (`group_id`, `authority`) VALUES
	(1, 'ROLE_ADMIN'),
	(1, 'ROLE_USER');
...
INSERT INTO `groups_members` (`group_id`, `username`) VALUES
	(1, 'admin'),
	(2, 'raul'),
	(3, 'gaby'),
	(4, 'test'),
...
DELETE FROM `grupo_cuentas`;
/*!40000 ALTER TABLE `grupo_cuentas` DISABLE KEYS */;
INSERT INTO `grupo_cuentas` (`grupo_cuenta_id`, `grupo_tipo_cuenta`, `grupo_cuenta_desc`) VALUES
	(7, 'INGRESO', 'BANCOS'),
	(8, 'INGRESO', 'EFECTIVO'),
	(9, 'INGRESO', 'TARJETAS'),
	(10, 'GASTOS', 'PRODUCTOS'),
...
CREATE TABLE IF NOT EXISTS `historial_pagos` (
  ...
  `hist_pagos_caja_id` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `historial_pagos` (`hist_pagos_id`, `hist_pagos_caja_id`, `hist_pagos_trat_pac_id`, `hist_tipo_pago`, `hist_pagos_fecha_pago`, `hist_pagos_hora_pago`, `hist_pagos_monto`, `hist_pagos_usuario`) VALUES
	(771, 119, 658, 'EFECTIVO', '2016-07-20', NULL, 850, NULL),
	(772, 119, 659, 'OCA', '2016-07-20', NULL, 10500, NULL);
...
INSERT INTO `historia_clinica` (`hist_id`, `pac_cedula`, `diabetes`, `epilepsia`, `marcaPaso`, `diu`, `problemas_cardiacos`, `medicacion`, `cant_hijos`, `operaciones`, `hipertension`, `procesos_oncologicos`, `tiroides`, `actividad_fisica`, `agua_diaria`, `alimentacion`) VALUES
...
INSERT INTO `impuesto` (`impuesto_id`, `impuesto_desc`, `impuesto_desc_abrv`, `impuesto_valor`, `impuesto_tipo`, `impuesto_cuenta`) VALUES
...
INSERT INTO `lista_precios` (`list_prec_id`, `list_prec_id_trat`, `list_prec_monto`) VALUES
	(1, 2, 850),
	(1, 7, 10500),
	(1, 8, 4000),
	(1, 9, 13500),
...
DELETE FROM `nic_roles`;
/*!40000 ALTER TABLE `nic_roles` DISABLE KEYS */;
INSERT INTO `nic_roles` (`nic_rol_id`, `nic_rol_user_nic_id`, `nic_rol_name_id`) VALUES
	(1, 1, 1),
	(2, 2, 1),
	(3, 3, 2),
	(4, 4, 2);
...
INSERT INTO `pacientes` (`pac_id`, `pac_nombre`, `pac_apellido`, `cedula`, `pac_ocupacion`, `pac_soc_med`, `pac_em_movil`) VALUES
...
CREATE TABLE IF NOT EXISTS `pago_efectivo` (
  ...
  `pago_ef_caja_id` int(11) NOT NULL DEFAULT '0',
  `pago_ef_asiento_nro` int(11) NOT NULL DEFAULT '0',
  `pago_ef_id` int(11) NOT NULL,
  `pago_ef_cedula` int(11) NOT NULL,
  `pago_ef_importe` int(11) NOT NULL,
  `pago_ef_cuenta` varchar(50) NOT NULL,
...
DELETE FROM `pago_efectivo`;
/*!40000 ALTER TABLE `pago_efectivo` DISABLE KEYS */;
INSERT INTO `pago_efectivo` (`ef_id`, `pago_ef_caja_id`, `pago_ef_asiento_nro`, `pago_ef_id`, `pago_ef_cedula`, `pago_ef_importe`, `pago_ef_cuenta`, `pago_ef_desc`, `pago_ef_usuario`) VALUES
	(450, 119, 2, 658, 44188684, 850, 'EFECTIVO_CAJA', 'EFECTIVO', NULL);
...
CREATE TABLE IF NOT EXISTS `pago_tarjetas` (
  ...
  `tarjeta_caja_id` int(11) NOT NULL DEFAULT '0',
  `tarjeta_asiento_nro` int(11) NOT NULL DEFAULT '0',
  ...
  `tarj_cuenta` varchar(50) NOT NULL,
  `tarj_cuotas` int(11) NOT NULL,
  `tarj_pago_usuario` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`tarj_id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=latin1;

DELETE FROM `pago_tarjetas`;
/*!40000 ALTER TABLE `pago_tarjetas` DISABLE KEYS */;
INSERT INTO `pago_tarjetas` (`tarj_id`, `tarjeta_caja_id`, `tarjeta_asiento_nro`, `tarj_pac_cedula`, `tarj_pago_id`, `tarj_nro`, `tarj_desc`, `tarj_vence`, `tarj_importe`, `tarj_cuenta`, `tarj_cuotas`, `tarj_pago_usuario`) VALUES
	(36, 119, 3, 44188684, 659, 154321654325, 'OCA', '2016-07-15', 10500, 'OCA', 10, NULL);
...
DELETE FROM `seguimiento_pacientes`;
/*!40000 ALTER TABLE `seguimiento_pacientes` DISABLE KEYS */;
INSERT INTO `seguimiento_pacientes` (`seg_pac_id`, `trat_pac_id`, `fecha_control`, `brazo_izquierdo`, `brazo_derecho`, `muzlo_izquierdo`, `muzlo_derecho`, `abdomen`, `cintura`, `cadera`, `peso`, `imc`, `observaciones`) VALUES
	(1, 647, '2016-07-14', 10, 20, 30, 40, 50, 60, 70, 80, 2.3, 'OK');
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_resumenPorCuentasTotal`(cuentaTipo VARCHAR(10))
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_resumenPorCuentasTotalPorCaja`(cuentaTipo VARCHAR(10), idCaja INT)
BEGIN
 CREATE TEMPORARY TABLE tmp_haber
	SELECT as_con_caja_id, as_cuenta_haber cuenta_haber, SUM(as_cuenta_haberMonto) haber, as_cuenta_tipo tipo
	FROM asiento_contable
...
INSERT INTO `tipo_tratamiento` (`tip_trat_id`, `tip_trat_descripcion`) VALUES
	(1, 'Relax'),
	(2, 'Terapeutico'),
	(3, 'Modelador'),
	(4, 'Estetico'),
...
INSERT INTO `tratamiento` (`trat_id`, `trat_tpo_id`, `trat_descripcion`, `trat_cant_sesiones`, `trat_ipuesto_id`) VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=660 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

DELETE FROM `tratamiento_paciente`;
/*!40000 ALTER TABLE `tratamiento_paciente` DISABLE KEYS */;
INSERT INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	(658, 44188684, 2, '2016-07-20', 850, 850, 0, 1),
	(659, 44188684, 7, '2016-07-20', 10500, 10500, 0, 10);
