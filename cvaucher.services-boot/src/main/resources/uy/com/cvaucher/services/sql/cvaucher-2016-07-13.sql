...
-- Volcando datos para la tabla est_vaucher.agenda: ~130 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.asiento_contable: ~9 rows (aproximadamente)
...
REPLACE INTO `asiento_contable` (`as_con_id`, `as_con_caja_id`, `as_con_nro`, `as_cuenta_debe`, `as_cuenta_debeMonto`, `as_cuenta_haber`, `as_cuenta_haberMonto`, `as_cuenta_tipo`, `as_con_descripcion`, `as_con_fecha`, `as_con_hora`, `as_con_usr`) VALUES
	(214, 119, 1, 1, 850, 1, 0, 1, 'EFECTIVO_CAJA', NULL, NULL, NULL),
	(215, 119, 1, 9, 0, 9, 187, 2, 'IVA 22%', NULL, NULL, NULL),
	(216, 119, 1, 12, 0, 12, 663, 3, 'Ultracavitacion', NULL, NULL, NULL),
	(217, 119, 2, 2, 850, 2, 0, 1, 'OCA', NULL, NULL, NULL),
	(218, 119, 2, 9, 0, 9, 187, 2, 'IVA 22%', NULL, NULL, NULL),
	(219, 119, 2, 12, 0, 12, 663, 3, 'Ultracavitacion', NULL, NULL, NULL),
	(220, 119, 3, 3, 850, 3, 0, 1, 'VISA', NULL, NULL, NULL),
	(221, 119, 3, 9, 0, 9, 187, 2, 'IVA 22%', NULL, NULL, NULL),
	(222, 119, 3, 12, 0, 12, 663, 3, 'Ultracavitacion', NULL, NULL, NULL);
...
-- Volcando datos para la tabla est_vaucher.caja: ~51 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.direccion: ~88 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~3 rows (aproximadamente)
...
REPLACE INTO `historial_pagos` (`hist_pagos_id`, `hist_pagos_caja_id`, `hist_pagos_trat_pac_id`, `hist_tipo_pago`, `hist_pagos_fecha_pago`, `hist_pagos_hora_pago`, `hist_pagos_monto`, `hist_pagos_usuario`) VALUES
	(745, 119, 630, 'EFECTIVO', '2016-07-11', NULL, 850, NULL),
	(746, 119, 631, 'OCA', '2016-07-11', NULL, 850, NULL),
	(747, 119, 632, 'VISA', '2016-07-11', NULL, 850, NULL);
...
-- Volcando datos para la tabla est_vaucher.historia_clinica: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.pacientes: ~88 rows (aproximadamente)
...
REPLACE INTO `pago_efectivo` (`ef_id`, `pago_ef_caja_id`, `pago_ef_id`, `pago_ef_cedula`, `pago_ef_importe`, `pago_ef_cuenta`, `pago_ef_desc`, `pago_ef_usuario`) VALUES
	(439, 119, 630, 44188684, 850, 'EFECTIVO_CAJA', 'EFECTIVO', NULL);
...
-- Volcando datos para la tabla est_vaucher.pago_tarjetas: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `pago_tarjetas` DISABLE KEYS */;
REPLACE INTO `pago_tarjetas` (`tarj_id`, `tarjeta_caja_id`, `tarj_pac_cedula`, `tarj_pago_id`, `tarj_nro`, `tarj_desc`, `tarj_vence`, `tarj_importe`, `tarj_cuenta`, `tarj_cuotas`, `tarj_pago_usuario`) VALUES
	(22, 119, 44188684, 631, 12203625987854123, 'OCA', '2016-07-30', 850, 'OCA', 10, NULL),
	(23, 119, 44188684, 632, 5236256985874521, 'VISA', '2016-07-20', 850, 'VISA', 1, NULL);
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_resumenPorCuentasTotalPorCaja`(cuentaTipo INT, idCaja INT)
BEGIN
 CREATE TEMPORARY TABLE tmp_haber
	SELECT as_con_caja_id, as_cuenta_haber cuenta_haber, SUM(as_cuenta_haberMonto) haber, as_cuenta_tipo tipo
	FROM asiento_contable
...
) ENGINE=InnoDB AUTO_INCREMENT=633 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~3 rows (aproximadamente)
...
REPLACE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	(630, 44188684, 2, '2016-07-11', 850, 850, 0, 1),
	(631, 44188684, 2, '2016-07-11', 850, 850, 0, 1),
	(632, 44188684, 2, '2016-07-11', 850, 850, 0, 1);
