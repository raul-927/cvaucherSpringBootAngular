...
-- Volcando datos para la tabla est_vaucher.impuesto: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `impuesto` DISABLE KEYS */;
REPLACE INTO `impuesto` (`impuesto_id`, `impuesto_desc`, `impuesto_desc_abrv`, `impuesto_valor`) VALUES
	(1, 'Impuesto al Valor Agregado', 'IVA', 22.000),
	(2, 'Sin Impuestos', 'S/IMP', 0.000),
	(3, 'Impuesto Recaudacion Personas Fisicas Franja 1', 'IRPF_F1', 0.000),
	(4, 'Impuesto Recaudacion Personas Fisicas Franja 2', 'IRPF_F2', 10.000),
	(5, 'Impuesto Recaudacion Personas Fisicas Franja 3', 'IRPF_F3', 18.000),
	(6, 'Impuesto Recaudacion Personas Fisicas Franja 4', 'IRPF_F4', 23.000),
	(7, 'Impuesto Recaudacion Personas Fisicas Franja 5', 'IRPF_F5', 26.000),
	(8, 'Impuesto Recaudacion Personas Fisicas Franja 6', 'IRPF_F6', 29.000),
	(9, 'Impuesto Recaudacion Personas Fisicas Franja 7', 'IRPF_F7', 34.000),
	(10, 'Fondo de Reconversión Laboral', 'FRL', 0.125),
	(12, 'Banco de Prevision Social Aporte Jubilatorio', 'BPS_AJ', 7.500),
	(13, 'Fondo Nacional de Salud', 'FONASA', 3.000);
